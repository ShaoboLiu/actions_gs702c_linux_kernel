...
MODULE_ALIAS("usb:v0416pA91Ad*dc*dsc*dp*ic0Eisc01ip00*");
...
MODULE_ALIAS("usb:v05A9p2640d*dc*dsc*dp*ic0Eisc01ip00*");
MODULE_ALIAS("usb:v05ACp8501d*dc*dsc*dp*ic0Eisc01ip00*");
MODULE_ALIAS("usb:v05C8p0403d*dc*dsc*dp*ic0Eisc01ip00*");
...
MODULE_ALIAS("usb:v199Ep8102d*dc*dsc*dp*icFFisc01ip00*");
...
MODULE_INFO(srcversion, "6A26CEAF82F6F168BCD7F62");
